...
**Connection-less**
From the advertisement data, inspect the `manufacturer data` field. The next to the last byte in that data array will be a boolean flag describing the current state (`0x00` for off, `0x01` for on).
